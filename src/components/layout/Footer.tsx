...
export function Footer() {
  ...
  const socials = [
    { key: 'github', url: contactInfo.social.github, icon: socialIcons.github, label: 'GitHub' },
    { key: 'instagram', url: contactInfo.social.instagram, icon: socialIcons.instagram, label: 'Instagram' },
    { key: 'linkedin', url: contactInfo.social.linkedin, icon: socialIcons.linkedin, label: 'LinkedIn' },
    { key: 'upwork', url: contactInfo.social.upwork, icon: socialIcons.upwork, label: 'Upwork' },
  ];
